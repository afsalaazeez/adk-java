...
public class AgentController {
	...
	public AgentController(AgentLoader agentProvider) {
		...
		log.info("AgentController initialized with {} dynamic agents: {}", agentNames.size(), agentNames);
	...
	/**
	 * Lists available applications. Currently returns only the configured root agent's
	 * name.
