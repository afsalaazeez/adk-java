...
public class DebugController {
	 ...
	 * based on event ID.
	 * @param eventId The ID of the event to trace (expected to be
	 ...
	 * @return A ResponseEntity containing a list of span data maps for the session, or an
	 * empty list.
	 */
	...
	public ResponseEntity<Object> getSessionTrace(@PathVariable String sessionId) {
		...
		List<SpanData> allSpansSnapshot = new ArrayList<>(this.apiServerSpanExporter.getAllExportedSpans());
